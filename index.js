...
var S = {
  init: function () {
    ...
    if (i !== -1) {
      ...
      S.UI.simulate('|#countdown 3||ʚ赵爽ɞ|祝你|生日|快乐呀！|天天|开心哟！| (◦˙▽˙◦) ♡  ');
    }
    ...
    timedAction(function (index) {
      ...
      switch (action) {
        ...
        case 'love':
          ...
          S.Shape.switchShape(S.ShapeBuilder.love(Math.min(maxShapeSize, parseInt(value[0])), Math.min(maxShapeSize, parseInt(value[1]))));
          break;
